...
uint8_t* lockStartAddr   = 0x43d00000;
uint8_t* lockStartAddrNc = 0x43d01000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0x43d00000;
  uint8_t* lockStartAddrNc = (uint8_t*)0x43d01000; // non-cacheable
