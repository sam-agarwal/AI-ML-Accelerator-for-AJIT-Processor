...
SETUP_THREAD_0_0:
  ...
  set 0x43d05fa0, %sp  ! set stack address
  clr %fp
...
SETUP_THREAD_0_1:
  ...
  set 0x43d08fa0, %sp  ! set stack address
  clr %fp
...
__cortos_init_region_to_zero:
  ...
  sethi %hi(0x42e00000), %l0
  or %l0, %lo(0x42e00000), %l0

  ! set the first illegal address
  sethi %hi(0x43d00000), %l2
  or %l2, %lo(0x43d00000), %l2
...
_cortos_zero_init_area_BssSection:
  ...
  ! set the base address
  sethi %hi(0x43d00000), %l0
  or %l0, %lo(0x43d00000), %l0

  ! set the first illegal address
  sethi %hi(0x43d01000), %l2
  or %l2, %lo(0x43d01000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
...
_cortos_zero_init_area_CacheableLocks:
  ...
  ! set the base address
  sethi %hi(0x43d01000), %l0
  or %l0, %lo(0x43d01000), %l0

  ! set the first illegal address
  sethi %hi(0x43d02000), %l2
  or %l2, %lo(0x43d02000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
